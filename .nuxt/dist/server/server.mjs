...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/index.2e1f7aef.js").then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    ...
    component: () => import("./_nuxt/login.9ea9ece3.js").then((m) => m.default || m)
  },
  {
    name: "register",
    path: "/register",
    ...
    component: () => import("./_nuxt/register.76b8460b.js").then((m) => m.default || m)
  },
  {
    name: "tasks",
    path: "/tasks",
    ...
    component: () => import("./_nuxt/tasks.be413b81.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component.e328e2b5.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();

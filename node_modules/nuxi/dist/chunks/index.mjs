...
import { j as joinURL } from '../shared/nuxi.b6e8da95.mjs';
...
async function listen(handle, opts = {}) {
  ...
  if (opts.https) {
    ...
    server = require$$1.createServer({ key, cert }, handle);
    addShutdown(server);
...
async function getSelfSignedCert(opts = {}) {
  const { generate } = await import('./index3.mjs').then(function (n) { return n.i; });

...
const _routes = [
  {
    name: "index",
    path: "/",
    file: "/home/francis/Documents/NUXT3-CODES/paypal-nuxt/pages/index.vue",
    children: [],
    meta: meta$3,
    alias: [],
    component: () => import('./_nuxt/index.2e1f7aef.mjs').then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    file: "/home/francis/Documents/NUXT3-CODES/paypal-nuxt/pages/login.vue",
    children: [],
    meta: meta$2,
    alias: [],
    component: () => import('./_nuxt/login.9ea9ece3.mjs').then((m) => m.default || m)
  },
  {
    name: "register",
    path: "/register",
    file: "/home/francis/Documents/NUXT3-CODES/paypal-nuxt/pages/register.vue",
    children: [],
    meta: meta$1,
    alias: [],
    component: () => import('./_nuxt/register.76b8460b.mjs').then((m) => m.default || m)
  },
  {
    name: "tasks",
    path: "/tasks",
    file: "/home/francis/Documents/NUXT3-CODES/paypal-nuxt/pages/tasks.vue",
    children: [],
    meta,
    alias: [],
    component: () => import('./_nuxt/tasks.be413b81.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component.e328e2b5.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();

...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404.fcec3c34.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500.a776f910.mjs').then((r) => r.default || r));
...
//# sourceMappingURL=error-component.e328e2b5.mjs.map
